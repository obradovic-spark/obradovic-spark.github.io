...
<section class="task-panel intro-panel is-visible" data-task="intro">
  <div class="intro-hero">
    <h1 class="magic-title magic-title--hero" aria-label="MAGIC">
      <span class="letter letter-m">M</span><span class="letter letter-a">A</span><span class="letter letter-g">G</span><span class="letter letter-i">I</span><span class="letter letter-c">C</span>
    </h1>
    <p class="magic-subtitle magic-subtitle--hero">
      <span class="word"><span class="letter letter-m">M</span>easuring</span>
      <span class="word"><span class="letter letter-a">A</span>cquisition</span>
      <span class="word">&amp;</span>
      <span class="word"><span class="letter letter-g">G</span>rowth</span>
      <span class="word">of</span>
      <span class="word"><span class="letter letter-i">I</span>nquiry</span>
      <span class="word">&amp;</span>
      <span class="word"><span class="letter letter-c">C</span>uriosity</span>
    </p>
    <p class="intro-lead">
      Performance-based assessment tasks for young learners' curiosity, creative thinking, problem-solving, and scientific inquiry.
    </p>
    <a class="lab-link lab-link--hero" href="https://sparklab.stanford.edu/magic" target="_blank" rel="noopener noreferrer">
      Learn more about the MAGIC project!
    </a>
  </div>
</section>

<section class="task-panel" data-task="busy-board" data-task-title="Busy board">
  ...
  {% capture task_trailer %}{% include_relative content/busy-board/task-trailer.md %}{% endcapture %}
...
<section class="task-panel" data-task="scientific-reasoning" data-task-title="Scientific reasoning">
  ...
  {% capture task_trailer %}{% include_relative content/scientific-reasoning/task-trailer.md %}{% endcapture %}
...
<section class="task-panel" data-task="crafting" data-task-title="Crafting">
  ...
  {% capture task_trailer %}{% include_relative content/crafting/task-trailer.md %}{% endcapture %}
...
<section class="task-panel" data-task="alternate-uses" data-task-title="Alternate uses">
  ...
  {% capture task_trailer %}{% include_relative content/alternate-uses/task-trailer.md %}{% endcapture %}
